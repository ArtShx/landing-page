...
function ContactMe() {
  return (
    <section id="contact" className="mb-20 sm:mb-28 w-[min(100%,38rem)] text-center mx-auto">
      ...
      <p className="text-gray-700 -mt-6 dark:text-white/80">Please contact me at <a className="underline" href="mailto:miada.arthur@gmail.com">miada.arthur@gmail.com</a> or through this form.</p>
