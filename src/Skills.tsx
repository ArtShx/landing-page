...
export function Skills() {
  return (
    <section id="skills" className="mb-28 max-w-[58rem] scroll-mt-28 text-center sm:mb-40">
        ...
        Array.from(my_skills.entries()).map(([key, value]) => {
          return (
            <li key={key} className="flex flex-col items-center px-4 py-3 dark:text-white/80">
              <img src={value.logo} alt={value.name} className="h-14 text-5xl md:text-7xl iconify iconify--logos hover:scale-125" />
